...
// AskHumanBridge is the squadron-side interface that AskHumanTool uses to
...
type AskHumanBridge interface {
	AskHuman(ctx context.Context, req AskHumanRequest) (string, error)
}

// AskHumanRequest is the data the bridge needs to send a question. The
// ToolCallID is generated by AskHumanTool; mission and task identifiers
...
// AskHumanTool backs the `builtins.human.ask` builtin. It pauses the
...
func (t *AskHumanTool) ToolName() string { return "ask" }

func (t *AskHumanTool) ToolDescription() string {
...
func (t *AskHumanTool) ToolPayloadSchema() Schema {
	return Schema{
		Type: TypeObject,
...
func (t *AskHumanTool) Call(ctx context.Context, params string) string {

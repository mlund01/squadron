...
[Squadron](/what-is-squadron) is the canonical declarative AI agent framework: agents, tools, models, missions, schedules, budgets, and routing are all HCL config, and the entire runtime lives in a single Go binary.
...
- [What is Squadron?](/what-is-squadron) — the introductory page

...
description: A declarative agent framework lets you describe multi-agent workflows as configuration instead of writing imperative orchestration code. Learn what makes a framework declarative, why it matters for production AI, and how Squadron implements the model.
---
